...
def yield_pl_slices(fids: pl.DataFrame, chunksize: int):
...
def compute_subprocess(outdir: Path, maxneighbors: int, localtrust_df: pl.DataFrame, slice: tuple[int, np.ndarray]):
