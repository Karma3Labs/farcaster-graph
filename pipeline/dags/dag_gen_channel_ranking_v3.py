...
def create_dag():
    ...
    fetch_data_task >> extract_ids_task >> process_7d_tasks >> process_60d_tasks >> process_lifetime_tasks >> refresh_db_task >> push_to_dune_task >> push_to_s3_task >> trigger_sync_sandbox
