...
# Run
echo "Running channel followers import with flags $CSV_FILE $SCOPE $DAEMON_FLAG"
/usr/bin/env python3 -m extractors.main_channel_followers -c $CSV_FILE -s $SCOPE $DAEMON_FLAG 
