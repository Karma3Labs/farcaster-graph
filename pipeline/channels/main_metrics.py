...
def main():
    ...
    channel_db_utils.upsert_weekly_metrics(logger, pg_dsn, sql_timeout_ms, Metric.WEEKLY_NUM_CASTS)
    channel_db_utils.upsert_weekly_metrics(logger, pg_dsn, sql_timeout_ms, Metric.WEEKLY_UNIQUE_CASTERS)
